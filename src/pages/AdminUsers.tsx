...
const roleColors: Record<string, string> = {
  ...
  chef: "bg-primary-100 text-primary-800",
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <UserCog className="text-primary-500" /> Staff Management
            </h1>
            <p className="text-sm text-muted-foreground mt-1">Manage your restaurant's staff accounts</p>
          </div>
          <Button onClick={() => setShowAdd(true)} className="bg-primary-500 hover:bg-primary-600">
            ...
            <CardContent>
              <form onSubmit={handleAdd} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-2 flex gap-2 justify-end">
                  ...
                  <Button type="submit" disabled={saving} className="bg-primary-500 hover:bg-primary-600">
